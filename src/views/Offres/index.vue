      ...
      <div class="plan">
        ...
        <div class="plan-select">
          <router-link to="#"
                       ...
                       @click="purchaseMonthlyPlan('price_1Iow3UEQZ5CWt7xomdoD6Ku1')"
          >
            <img
                class="loader"
                v-if="isPurchasing"
      ...
      <div class="plan featured">
        ...
        <div class="plan-select">
          <router-link to="#"
                       class="pricingTable-firstTable_table__getstart pricing-button"
                       :disabled="isPurchasing"
                       @click="purchaseMonthlyPlan('price_1Iow4EEQZ5CWt7xo9TVI885U')"
          >
            <img
                class="loader"
                v-if="isPurchasing"
      ...
      <div class="plan">
        ...
        <div class="plan-select">
          <router-link to="#"
                       class="pricingTable-firstTable_table__getstart pricing-button"
                       :disabled="isPurchasing"
                       @click="purchaseMonthlyPlan('price_1Iow4kEQZ5CWt7xothMe9M6i')"
          >
            <img
                class="loader"
                v-if="isPurchasing"

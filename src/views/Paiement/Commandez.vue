...
export default defineComponent({
  ...
  data(){
    return {
      stripeKey: 'pk_live_51HwcPhKYGE5dRt9iNKN0is2ifvwrSgO3kM8AwkKZZTNd8PezvjYKIpgxJiXM9JidoiFSMXVodo3Ke2y47RFXDme100vpXBv3ca',
      // fields
      name: 'Connor Leech',
  ...
  methods: {
    ...
    stripeResponseHandler(status, response) {
      ...
      if (response.error) {
        ...
        // Send to our server
        axios.post(`https://agencyskyplus.herokuapp.com/charge/charge`, request)
            .then((res) => {
              ...
              if (error){
                ...
                this.$router.push({ path: `commande-complete/${charge.id}` })
              }
            });
      }
    }

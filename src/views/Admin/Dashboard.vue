            ...
            <div class="bg-white overflow-auto">
              <table class="min-w-full bg-white">
                ...
                <tr class="bg-gray-200">
                  ...
                  <td class="text-left py-3 px-4"><a class="color-text" href="mailto:jonsmith@mail.com">jonsmith@mail.com</a></td>
                  <td class="text-left py-3 px-4"><a class="color-text" href="mailto:jonsmith@mail.com">En cours </a></td>
                </tr>
                </tbody>
              </table>
            </div>

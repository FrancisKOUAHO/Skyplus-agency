...
import TableFacture from "@/components/ComponentsAdmins/Tables/TableFacture";
import Invoice from "@/components/ComponentsAdmins/FormFacturation/Invoice";

export default {
  name: "Facturation",
  components: {Invoice, TableFacture, DropdownDashboard, HeaderDashboard},
  data() {
    return {
      user: {},
      isOpen1: false,

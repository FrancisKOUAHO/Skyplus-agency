<template>
  <div class="flex justify-center">
    <div class="title_desc">
        <h1 class="text-6xl mt-12 relative fadeInUp" style="text-decoration: none; text-decoration-line: none">Notre histoire</h1>
